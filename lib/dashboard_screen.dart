  ...
  Widget _buildAttendanceBottom() {
    return Container(
      ...
      child: Row(
        children: [
          Expanded(
            child: _buildTimeInfo('Check In', '09:00 AM', Icons.login),
          ),
          Container(
            width: 1,
            height: 50,
          ...
          Expanded(
            child: _buildTimeInfo('Check Out', '06:00 PM', Icons.logout),
          ),
        ],
      ),
    );
